...
void YSViewDidMoveToSuperview(UIView *self, SEL _cmd) {
    ...
    if (([self isKindOfClass:[UITextField class]] || [self isKindOfClass:[UITextView class]] || [self methodForSelector:@selector(setInputView:)] != nil) && self.kbMoving.kbMovingView == nil) {
